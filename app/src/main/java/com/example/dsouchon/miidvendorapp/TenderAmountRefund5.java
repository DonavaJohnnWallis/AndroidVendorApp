 ...
 */
public class TenderAmountRefund5 extends AppCompatActivity {
    private Spinner spinner2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tenderamountrefund5);
    ...
    public void onBackPressed() {
        // your code.
        Toast.makeText(TenderAmountRefund5.this, "Select Home in Main Menu to go back.", Toast.LENGTH_SHORT).show();
    }
    ...
    public void TenderAmountRefund(View view) {
        ...
        Intent intent = new Intent(TenderAmountRefund5.this, ScanTagPinRefund6.class );
        finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_vendorLogin:
                ...
                Intent intent1 = new Intent(TenderAmountRefund5.this, MainActivity.class );
