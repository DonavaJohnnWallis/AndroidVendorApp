 ...
 */
public class ScanTagPinRefund6 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        // your code.
        Toast.makeText(ScanTagPinRefund6.this, "Select Home in Main Menu to go back.", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.scantagpinrefund6);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_vendorLogin:
                ...
                Intent intent1 = new Intent(ScanTagPinRefund6.this, MainActivity.class );
    ...
    public class CallSoapScanTagForPayment6 extends AsyncTask<ScanTagForPayment6Parameters, Void, String> {
        ...
        protected String doInBackground(ScanTagForPayment6Parameters... params) {
            return params[0].sca.ScanTagForPaymentRefund6(params[0].TagNumber);
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.toString().contains("|")) {
                Intent intent = new Intent(ScanTagPinRefund6.this, PaymentResultRefund7.class );
...
//Webmethod functions end
    ...
    public void EnterPin(View view) {
        ...
        try {
            ...
            PaymentResultRefund7Parameters params = new PaymentResultRefund7Parameters (cs, PinNumber, TagNumber, Amount, EventID, VendorID, DeviceCode, StaffID, ShiftNo);

            new CallSoapPaymentResultRefund7().execute(params);
    ...
    //Webmethod functions start
    public class CallSoapPaymentResultRefund7 extends AsyncTask<PaymentResultRefund7Parameters, Void, String> {

        private Exception exception;

        //After the webmethod is called
        @Override
        protected String doInBackground(PaymentResultRefund7Parameters... params) {
            return params[0].sca.PaymentResultRefund7(params[0].PinNumber, params[0].TagNumber, params[0].Amount, params[0].EventID, params[0].VendorID, params[0].DeviceCode, params[0].StaffID, params[0].ShiftNo);
        }
    ...
    private static class PaymentResultRefund7Parameters {
        MySOAPCallActivity sca;
        Integer PinNumber;
        String TagNumber;
        Integer Amount;
        ...
        PaymentResultRefund7Parameters(MySOAPCallActivity sca,   Integer PinNumber, String TagNumber,
                                 Integer Amount,
                                 Integer EventID,
                                 Integer VendorID,
                                 String DeviceCode,
...
//NFC Stuff Start - COMMENTING OUT FOR DEBUGGING
        ...
        if (intent.hasExtra(NfcAdapter.EXTRA_TAG)) {
            ...
            if(parcelables != null && parcelables.length > 0){
                ...
                try{
                    ...
                    //final GlobalClass globalVariable = (GlobalClass) getApplicationContext();
                    ScanTagForPayment6Parameters params = new ScanTagForPayment6Parameters(cs, tagNo);
                    new CallSoapScanTagForPayment6().execute(params);
    ...
    private void enableForegroundDispatchSystem(){
        Intent intent = new Intent(this, ScanTagPinRefund6.class).addFlags(Intent.FLAG_RECEIVER_REPLACE_PENDING);
